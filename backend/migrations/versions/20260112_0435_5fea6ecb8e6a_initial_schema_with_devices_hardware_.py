"""Initial schema with devices, hardware_specs, services, metrics,
and provisioning_jobs tables.
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum(
                "SERVER", "VM", "CONTAINER", "NETWORK", "STORAGE", name="devicetype"
            ),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "INACTIVE", "MAINTENANCE", name="devicestatus"),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("ix_hardware_specs_id"), "hardware_specs", ["id"], unique=False
    )
    op.create_table(
        "metrics",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("RUNNING", "STOPPED", "ERROR", name="servicestatus"),
            nullable=True,
        ),
