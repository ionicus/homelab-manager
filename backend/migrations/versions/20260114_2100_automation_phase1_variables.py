...
down_revision: str | Sequence[str] | None = "113473d262e7"
...
def upgrade() -> None:
    ...
    if not table_exists("device_variables"):
        op.create_table(
            ...
            sa.UniqueConstraint(
                "device_id", "playbook_name", name="uq_device_playbook"
            ),
        )
        op.create_index(
            "ix_device_variables_device_id", "device_variables", ["device_id"]
        )
